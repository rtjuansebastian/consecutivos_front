...
class Header extends Component {     
    ...
    render() {
        ...
        const itemsMenu = [{titulo:'Documentos', url: '/documentos'}, {titulo:'Equipos', url: '/equipos'}, {titulo:'Tipos de Documento', url: '/tiposdocumentos'}, {titulo:'Usuarios', url: '/usuarios'}];
        return (
